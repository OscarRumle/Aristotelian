...
function AssocCharRow({ char, checked, note, onToggle, onNoteChange }) {
  return (
...
export function CreateObjectScreen({ world, onBack, onSave }) {
  ...
  const toggleAssoc = (char) => {
    setAssociations((prev) => {
      const exists = prev.find((a) => a.id === char.id);
      if (exists) return prev.filter((a) => a.id !== char.id);
      return [...prev, { kind: "character", id: char.id, note: "" }];
    });
  };
    ...
    <div className="screen" style={{ paddingBottom: "6rem" }}>
      ...
      <div className="form-stack">
        ...
        <div className="assoc-section">
          ...
          <div className="assoc-stub">Factions — coming soon</div>
          <div className="assoc-stub">Locations — coming soon</div>
        </div>
