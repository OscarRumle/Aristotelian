...
export function CreateLocationScreen({ world, onBack, onSave, refContext = null, onRefContextConsumed }) {
  ...
  const formState = { pitch, name, type, scale, status, access, typeSpecificFields: typeFields, associations, lens };
  ...
  return (
    <div className="screen cls-page" style={{ paddingBottom: "6rem" }}>
      ...
      <LensSelector tool="location" style={null} value={lens} onChange={setLens} />
